...
\FEItitleEn{Face classification with CNN on Android OS}
\FEIkeywords{Android, CNN, klasifikácia tváre, detekcia tváre, biometria}
\FEIkeywordsEn{Android, CNN, face classification, face detections, biometrics}
